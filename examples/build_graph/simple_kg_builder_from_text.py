...
# Neo4j db infos
URI = "bolt+ssc://075db98b.databases.neo4j.io"  # Using working protocol from previous example
AUTH = ("neo4j", "avo66SsqJi-njCsaJFgHS24iRYaRqW9olR1aQUKsACM")  # Using working credentials
DATABASE = "neo4j"
...
async def main() -> PipelineResult:
    llm = OpenAILLM(
        ...
        api_key=os.getenv("OPENAI_API_KEY"),  # Added API key
        model_params={
            "max_tokens": 2000,
        },
    )
